...
# from dataset_diff import KTDataset, pad_collate_akt
# from akt_model_diff import AKT
# from akt_run_diff import train_akt, test_akt, test_akt_one_student


from dataset import KTDataset, pad_collate_akt
from akt_model_LayerNorm_r2 import AKT
from akt_run import train_akt, test_akt, test_akt_one_student, test_akt_one_student_knowledge_state

from dkt_run import train_dkt, test_dkt, test_dkt_one_student
...
# python main.py --mode=2 --load_dir=train_AKT_Junyi_100to499_diff --student_i=
# python main.py --mode=2 --load_dir=train_AKT_Junyi_100to499_Layernorm_r2 --student_i=0

def get_parser():
    parser = argparse.ArgumentParser()
    parser.add_argument('--mode', type = int, default = 1, help = 'mode 0 is train, mode 1 is test')
    parser.add_argument('--model', type = str, default = 'AKT', help = 'choose the used model: DKT, AKT')
    parser.add_argument('--data_dir', type = str, default = 'data', help = 'Data dir for loading input data.')
    parser.add_argument('--load_dir', type = str, default = 'train_AKT_Junyi_100to499_diff', help = 'Where to load the trained model if finetunning. ' + 'Leave empty to train from scratch')
    parser.add_argument('--save_dir', type = str, default = 'logs', help = 'Where to save the trained model, leave empty to not save anything.')
    parser.add_argument('--data_file', type = str, default = 'junyi_500to999_for_test_dedup.csv', help = 'Name of input data file.')
    ...
    parser.add_argument('--response_count_file', type = str, default = 'junyi_500to999_for_test_dedup_count.csv', help = 'Number of responses per student.')
...
if __name__ == '__main__':
    ...
    test_loader = DataLoader(kt_dataset, batch_size = 64, shuffle = args.shuffle, num_workers = 0, collate_fn = pad_collate_akt)         
